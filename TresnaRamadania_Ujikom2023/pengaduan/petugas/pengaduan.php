        <div class="row">
          ...
          <h3 class="black-text"><b>Pengaduan</b></h3>
          </div>
        </div>
	...
	<?php 
		...
		<tr>
			...
			<td><a class="btn modal-trigger black" href="#more?id_pengaduan=<?php echo $r['id_pengaduan'] ?>">Detail</a> <a class="btn black" onclick="return confirm('Anda Yakin Ingin Menghapus Y/N')" href="index.php?p=pengaduan_hapus&id_pengaduan=<?php echo $r['id_pengaduan'] ?>">Hapus</a></td>
          ...
          <div class="modal-content">
            ...
            <?php 
	            ...
	            <div class="col s12 m6">
					<form method="POST">
						...
						<div class="col s12 input-field">
							<input type="submit" name="tanggapi" value="Kirim" class="btn black">
						</div>
					</form>
	            </div>
            <?php	}
			...
			<?php 
				if(isset($_POST['tanggapi'])){
					$tgl = date('Y-m-d');
					$query = mysqli_query($koneksi,"INSERT INTO tanggapan VALUES (NULL,'".$r['id_pengaduan']."','".$tgl."','".$_POST['tanggapan']."','".$_SESSION['data']['nama_petugas']."')");
					if($query){
