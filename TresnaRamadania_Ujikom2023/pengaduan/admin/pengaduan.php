<div class="row">
	...
	<?php 
		...
		<tr>
			...
			<td><a class="btn modal-trigger black" href="#more?id_pengaduan=<?php echo $r['id_pengaduan'] ?>">Detail</a>  <a class="btn black" onclick="return confirm('Anda Yakin Ingin Menghapus Data')" href="index.php?p=pengaduan_hapus&id_pengaduan=<?php echo $r['id_pengaduan'] ?>">Hapus</a></td>
            ...
            <?php 
	            ...
	            <div class="col s12 m6">
					<form method="POST">
						...
						<div class="col s12 input-field">
							<input type="submit" name="tanggapi" value="Kirim" class="black btn right">
						</div>
					</form>
	            </div>
            <?php	}
