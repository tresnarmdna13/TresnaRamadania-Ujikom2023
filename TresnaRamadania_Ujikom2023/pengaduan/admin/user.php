        <div class="row">
          <div class="col s12 m9">
            <h3 class="black-text"><b>User</b></h3>
          </div>  
	...
	<?php 
		...
		<tr>
			...
			<td><b><?php echo $r['level']; ?></b></td>
			<td><a onclick="return confirm('Anda Yakin Ingin Mengubah Data?')" class="btn black modal-trigger" href="#user_edit<?php echo $r['id_petugas'] ?>">Edit</a> <a onclick="return confirm('Anda Yakin Ingin Menghapus Data?')" class="btn black" href="index.php?p=user_hapus&id_petugas=<?php echo $r['id_petugas'] ?>">Hapus</a></td>
        ...
        <div id="user_edit<?php echo $r['id_petugas'] ?>" class="modal">
          <div class="modal-content">
			...
			<form method="POST">
				...
				<div class="col s12 input-field">
					<input type="submit" name="Update" value="Simpan" class="btn black">
				</div>
			</form>
        ...
        <div id="modal1" class="modal">
          <div class="modal-content">
			...
			<form method="POST">
				...
				<div class="col s12 input-field">
					<input type="submit" name="input" value="Simpan" class="btn black">
				</div>
			</form>
