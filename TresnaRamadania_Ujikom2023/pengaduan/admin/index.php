<?php 
 ...
 ?>
  ...
  <html>
    ...
    <body style="background:url(../img/pnga.png); background-size: cover;">
    ...
    <div class="row ">
      <div class="col s12 m3 "    >
          <ul id="slide-out" class="sidenav sidenav-fixed ">
              <li>
                  <div class="user-view">
                      <div class="background">
                          <img src="../img/pnga.png">
                      </div>
					  <a href="#user"><img class="circle" src="pp.jpg"></a>
			  ...
			  <li><a href="index.php?p=respon"><i class="material-icons black-text">book</i><b>Respon</b></a></li>
