<div class="row">
          <div class="col s12 m9">
            <h3 class="black-text"><b>Laporan</b></h3>
          </div> 
          <div class="col s12 m3">
            <div class="section"></div>
            <a class="waves-effect waves-light btn black" href="cetak.php"><i class="material-icons">print</i></a>
          </div>
        </div>
	...
	<?php 
		...
		<tr>
			...
			<td><a class="btn black modal-trigger" href="#laporan?id_tanggapan=<?php echo $r['id_tanggapan'] ?>">More</a></td>
