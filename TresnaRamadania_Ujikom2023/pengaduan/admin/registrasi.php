<div class="row">
          <div class="col s12 m9">
            <h3 class="black-text"><b>Registrasi</b></h3>
          </div>  
	...
	<?php 
		...
		<tr>
			...
			<td><a class="btn black modal-trigger" href="#regis_edit?nik=<?php echo $r['nik'] ?>">Edit</a> <a onclick="return confirm('Anda Yakin Ingin Menghapus Data')" class="btn black" href="index.php?p=regis_hapus&nik=<?php echo $r['nik'] ?>">Hapus</a></td>
          ...
          <div class="modal-content">
			...
			<form method="POST">
				<div class="col s12 input-field">
					...
					<input id="nik" type="text" name="nik" value="<?php echo $r['nik']; ?>">
				</div>
				<div class="col s12 input-field">
				...
				<div class="col s12 input-field">
					<input type="submit" name="Update" value="Simpan" class="black btn right">
				</div>
			</form>
        ...
        <div id="modal1" class="modal">
          <div class="modal-content">
			...
			<form method="POST">
				...
				<div class="col s12 input-field">
					<label for="telp">Telp</label>
					<input id="telp" type="text" name="telp" required="required" minlength="11" maxlength="13"><br><br>
				</div>
				<div class="col s12 input-field">
